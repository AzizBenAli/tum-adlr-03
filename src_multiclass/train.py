...
def train_model(model, train_loader, criterion, optimizer, scheduler, num_epochs=50, device='cpu', latent_reg_weight=1):
    ...
    for epoch in range(num_epochs):
        ...
        for batch in train_loader:
            ...
            predicted_sdf = model(shape_indices, label_indices, points)
...
if __name__ == "__main__":
    ...
    print(f"Number of embeddings: {num_embeddings}, Number of labels: {num_labels}")
    ...
    visualize_predictions(trained_model, val_loader, shape_idx=0, device=device)
